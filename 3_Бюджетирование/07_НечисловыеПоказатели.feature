...
Сценарий: 07.07 Создание экземпляра отчета - "ВА - Нечисловые показатели (приемник)"  
	...
	* Записываем документ и сверяем движения	
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "3_Бюджетирование\Макеты\ВА_РасчетВКоде_Движения.mxl" по шаблону
...
Сценарий: 07.09 Создание экземпляра отчета - "ВА - Группировка по аналитикам"  
	...
	* Проверяем движения	
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "3_Бюджетирование\Макеты\ВА_ГруппировкаПоАналитикам_Движения.mxl" по шаблону
