...
Сценарий: 10.01 Загрузка методической модели
	...
	* Загрузка модели
		...
		Если '$$ЭтоCPMWE$$' Тогда
			И в поле с именем 'ИмяФайлаЗагрузки' я ввожу текст "$КаталогПроекта$\3_Бюджетирование\Макеты\ADO\Model_ADO_WE.xml"
		ИначеЕсли '$$ЭтоУХ$$' Тогда
			Если '$$ВерсияУХ$$ = "3.1"' тогда
				И в поле с именем 'ИмяФайлаЗагрузки' я ввожу текст "$КаталогПроекта$\3_Бюджетирование\Макеты\ADO\Model_ADO_УХ31.xml"
			Если '$$ВерсияУХ$$ = "3.2"' тогда
				И в поле с именем 'ИмяФайлаЗагрузки' я ввожу текст "$КаталогПроекта$\3_Бюджетирование\Макеты\ADO\Model_ADO_УХ32.xml"	
		ИначеЕсли '$$ЭтоЕРПУХ$$' Тогда
			И в поле с именем 'ИмяФайлаЗагрузки' я ввожу текст "$КаталогПроекта$\3_Бюджетирование\Макеты\ADO\Model_ADO_ERP.xml"
	...
	* Настроим соответствия имен файлов
		...
		И в поле с именем 'ЭталонныйКаталог' я ввожу текст '$КаталогПроекта$\3_Бюджетирование\Макеты\ADO'
		И в поле с именем 'НачалоИмени' я ввожу текст '$КаталогПроекта$\3_Бюджетирование\Макеты\ADO'
...
Сценарий: 10.02 Создаем экземпляр отчета
	...
	* Сверим движения
		...
		И Пауза 5
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "3_Бюджетирование\Макеты\ВА_ТестЗагрузкиПоADO_Движения.mxl" по шаблону
