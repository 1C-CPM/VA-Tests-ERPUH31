...
Сценарий: 08.05 Создание экземпляра отчета - "ВА - Нарастающий итог (приемник)"  
	...
	* Сверяем результат
		Тогда табличный документ "ПолеТабличногоДокументаМакет" равен макету "3_Бюджетирование\Макеты\ВА_НарастающийИтог.mxl"
	...
	* Смотрим движения
		...
		Дано Табличный документ 'ОтчетТабличныйДокумент' равен макету "3_Бюджетирование\Макеты\ВА_НарастающийИтог_Движения.mxl" по шаблону
