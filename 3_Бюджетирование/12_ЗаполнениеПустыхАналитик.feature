...
Функционал: Автоматическое заполнение пустых аналитик
...
Сценарий: 12.02 Создаем вид отчета и структуру отчета
	...
	* Устанавливаем формулы
	...
	И Я для вида отчета "ВА - Заполнение пустых аналитик" я создаю многопериодный бланк по умолчанию

Сценарий: 12.03 Создаем экземпляр отчета без записи и заполнения аналитик

	И Я устанавливаю в константу "ПодставлятьЗначенияПоУмолчаниюВместоПустых" значение "ЛОЖЬ"	
	...
	* Сравниваем результат
		Тогда табличный документ "ПолеТабличногоДокументаМакет" равен:
			| 'ВА - Заполнение пустых аналитик(многопериодный)' | ''               | ''     | ''                | ''           | ''             | ''     | ''      | ''           |
			| ''                                                | ''               | ''     | ''                | ''           | ''             | ''     | ''      | ''           |
...
Сценарий: 12.04 Создаем экземпляр отчета без записи с заполнением аналитик
	...
	И Я устанавливаю в константу "ПодставлятьЗначенияПоУмолчаниюВместоПустых" значение "ИСТИНА"
