...
Сценарий: 06.02 Создание вида отчета "ВА - Данные для дополнения аналитик"					
	...
	* Создаем бланк отчета
		...
		И в таблице "Список" я перехожу к строке:
			| 'Наименование'                             |
			| 'ВА - Данные для дополнения аналитик(многопериодный)' |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Бланк ВА - Данные для дополнения аналитик(многопериодный) вида отчета: ВА - Данные для дополнения аналитик'
...
Сценарий: 06.04 Создание вида отчета "ВА - Аналитики из полей других источников"
	...
	* Создаем бланк отчета
		...
		И в таблице "Список" я перехожу к строке:
			| 'Наименование'                             |
			| 'ВА - Аналитики из полей других источников(многопериодный)' |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Бланк ВА - Аналитики из полей других источников(многопериодный) вида отчета: ВА - Аналитики из полей других источников'
		И я нажимаю на кнопку с именем 'ФормаСоздатьМакетИмпорта'
		Тогда открылось окно '1С:Предприятие'
		И я нажимаю на кнопку с именем 'Button0'
		Тогда открылось окно 'Структура отчета'
