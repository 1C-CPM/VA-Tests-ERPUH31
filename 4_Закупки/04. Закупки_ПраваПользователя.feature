...
Функционал: 04. Под пользователем "МенеджерПоЗакупкам1"
...
Сценарий: 04.02. [ЗАПРОС КОТИРОВОК] СПЗ-1 на два года
...
Сценарий: 04.08. [ЗАПРОС ПРЕДЛОЖЕНИЙ] ДД2 -> Заказ поставщику
