...
Функционал: 02. Под пользователем "МенеджерПоЗакупкам1"
...
Сценарий: 02.01. ПЗ (План закупок)
...
Сценарий: 02.02. [ЗАПРОС КОТИРОВОК] СПЗ-1 на два года
...
Сценарий: 02.03. [ЗАПРОС КОТИРОВОК] ЗП-1(лотовая)
...
Сценарий: 02.04. [ЗАПРОС КОТИРОВОК] Протокол -> ДД1(ЗП1)
...
Сценарий: 02.05. [ЗАПРОС КОТИРОВОК] ПТУ(ДД1)
...
Сценарий: 02.06. [ЗАПРОС ПРЕДЛОЖЕНИЙ] СПЗ-2
...
Сценарий: 02.07. [ЗАПРОС ПРЕДЛОЖЕНИЙ] ЗП-2(попозиционная)
...
Сценарий: 02.08. [ЗАПРОС ПРЕДЛОЖЕНИЙ] Протокол -> ДД2(ЗП2)
...
Сценарий: 02.08. [ЗАПРОС ПРЕДЛОЖЕНИЙ] ДД2 -> Заказ поставщику
