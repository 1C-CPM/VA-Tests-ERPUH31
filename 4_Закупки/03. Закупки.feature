...
Функционал: 03. Корпоративные закупки [МенеджерПоЗакупкам1]
...
Контекст:
	...
	И я подключаю TestClient "ЕРПУХ31 - Закупки" логин "МенеджерПоЗакупкам1" пароль ""
...
Сценарий: 03.08. [ЗАПРОС ПРЕДЛОЖЕНИЙ] ДД2 -> Заказ поставщику
	...
	* Вводим на основании договора Заказ поставщику
